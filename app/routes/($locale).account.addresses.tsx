...
export default function Addresses() {
  ...
  const showNewAddressForm = useSignal(false);

  const handleToggleNewAddressForm = () => {
    showNewAddressForm.value = !showNewAddressForm.value; // Toggle the signal value
  };
  ...
  return (
    <div className="account-addresses">
      ...
      <button
        ...
        className="mb-4 py-1 px-2 bg-blue-950 text-white text-base rounded-md w-max border-2 border-black hover:border-amber-500 hover:scale-105 active:scale-95"
      >
        {showNewAddressForm.value ? 'Cancel' : 'Add an Address'}{' '}
        {/* Toggle button text */}
      </button>
      {showNewAddressForm.value && ( // Render the form based on the signal
        <div>
          <legend className="mb-4 py-1 px-2 bg-gray-500 text-white text-base rounded-md w-max">
            Create address
          </legend>
          <NewAddressForm />
        </div>
      ...
      {({stateForMethod}) => (
        <div>
          <button
            ...
            formMethod="POST"
            type="submit"
            className="mb-12 py-1 px-2 bg-blue-950 text-white text-base rounded-md w-max border-2 border-black hover:border-amber-500 hover:scale-105 active:scale-95"
          >
  ...
  return (
    <div>
      ...
      {addresses.nodes.map((address) => (
        ...
        >
          {({stateForMethod}) => (
            <div className="flex justify-start gap-8 max-w-80 my-4">
              <button
...
export function AddressForm({
  ...
  return (
    <Form id={address.id}>
      <fieldset className=" max-w-[60rem] items-start place-items-center">
        {/* Dynamic grid layout */}
        ...
        <div className="flex items-center mb-8 gap-4 col-span-full">
          <input
