...
export default function BrandCollections() {
  ...
  return (
    <div className="collections mx-8 mb-8">
      <h1 className="text-6xl my-6 pt-4 w-full bg-blue-950 text-slate-100 border-2 border-gray-900 rounded-2xl text-center pb-6">
        Browse our Brands!
      </h1>
      ...
      query BrandCollections {
        ${brandCollectionHandles
          ...
          ${handle.replace(
            /-/g,
            '',
          )}: collectionByHandle(handle: "brand-${handle}") {
            ...Collection
          }
        `,
          )
