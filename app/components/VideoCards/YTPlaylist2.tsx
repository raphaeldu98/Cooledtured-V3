...
const YTPlaylist2: React.FC = () => {
  // Extracting playlist2 details and videos from the loader data
  const {youtube} = useLoaderData<LoaderData>();

  // Access details and videos for playlist2 directly
  const {id, details, videos} = youtube.playlist2;
